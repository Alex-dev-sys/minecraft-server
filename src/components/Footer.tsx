          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                className="clip-angle-sm flex items-center gap-3 px-4 py-3 border border-[#3A1017] bg-[#0d0d0d] hover:border-[#FF2B4F] hover:bg-[#130000] transition-all duration-200"
